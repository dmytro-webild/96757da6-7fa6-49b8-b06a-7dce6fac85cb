...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/front-view-burger-red-tasty-fried-inside-plate-light-wall_140725-11599.jpg",
          alt: "Customer 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/fancy-cuisine-with-yummy-hamburger_23-2148374860.jpg",
          alt: "Customer 2",
        },
        {
        ...
        {
          src: "http://img.b2bpic.net/free-photo/vertical-shot-delicious-burger-with-chicken-onions-rocket-served-with-fried-potatoes_181624-56472.jpg",
          alt: "Customer 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/front-view-delicious-meat-hamburger-with-red-tomatoes-dark-background_179666-19341.jpg",
          alt: "Customer 5",
        },
      ]}
      marqueeItems={[
  ...
  <div id="reviews" data-section="reviews">
      ...
      testimonials={[
        ...
        },
        {
          ...
          testimonial: "Service rapide w qualité top 💯",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/us-labor-day-celebration-with-burgers_23-2150347439.jpg",
          imageAlt: "kids burger meal nuggets fries",
        },
        {
          id: "t3",
          name: "Fares B.",
